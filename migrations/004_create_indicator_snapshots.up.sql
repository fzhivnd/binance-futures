...
CREATE INDEX IF NOT EXISTS idx_indicator_snapshots_trade_id ON indicator_snapshots (trade_id);
CREATE INDEX IF NOT EXISTS idx_indicator_snapshots_symbol   ON indicator_snapshots (symbol);
CREATE INDEX IF NOT EXISTS idx_indicator_snapshots_score    ON indicator_snapshots (composite_score DESC);
